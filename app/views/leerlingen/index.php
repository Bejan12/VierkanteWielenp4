...
<div class="user-overview-page">
            ...
            <tbody>
                <?php foreach ($data['leerlingen'] as $leerling): ?>
                    <tr>
                        ...
                        <td><?= htmlspecialchars($leerling->Leeftijd); ?></td>
                        <td><?= htmlspecialchars($leerling->Klas); ?></td>
                        <td><?= htmlspecialchars($leerling->Email); ?></td>
                        <td class="centered-cell">
                            <div class="icon-wrapper">
                                <a href="<?= URLROOT; ?>/leerlingen/edit/<?= $leerling->Id; ?>" title="Wijzig">
                                    <i class="bi bi-pencil-square action-icon edit-icon"></i>
                                </a>
                                <a href="<?= URLROOT; ?>/leerlingen/delete/<?= $leerling->Id; ?>" title="Verwijder" onclick="return confirm('Weet je zeker dat je deze leerling wilt verwijderen?');">
    ...
    <?php else: ?>
        <div class="no-users-message">
            <p>Er zijn nog geen leerlingen beschikbaar.</p>
